...
export default function Materials() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const materialData = {
      ...
      wastagePct: formData.wastagePct ? parseFloat(formData.wastagePct) : 8,
      marginPct: formData.marginPct ? parseFloat(formData.marginPct) : null,
      tileWidthMm: formData.tileWidthMm ? parseInt(formData.tileWidthMm) : null,
      tileHeightMm: formData.tileHeightMm ? parseInt(formData.tileHeightMm) : null,
      sheetWidthMm: formData.sheetWidthMm ? parseInt(formData.sheetWidthMm) : null,
      sheetHeightMm: formData.sheetHeightMm ? parseInt(formData.sheetHeightMm) : null,
      groutWidthMm: formData.groutWidthMm ? parseInt(formData.groutWidthMm) : null,
      thicknessMm: formData.thicknessMm ? parseInt(formData.thicknessMm) : null,

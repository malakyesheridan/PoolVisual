        ...
        <div className="flex-shrink-0 border-b bg-white">
          <div className="p-3 border-b">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-base font-semibold">Pool Templates</h3>
              {templates.length > 0 && (
          ...
          <div className="space-y-2">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search..."
                className="w-full px-2 pl-8 py-1.5 text-xs border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            </div>
          ...
          {templates.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-2">
              {templates.map((template) => (
                <div
                  key={template.id}
                  className="bg-white border rounded-lg hover:shadow-sm transition-all hover:border-gray-300 flex gap-2"
                >
                  {/* Template Preview */}
